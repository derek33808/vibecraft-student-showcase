# VibeCraft 学生作品展示投票墙 - 进度记录

## 当前状态：🟢 v2 已上线（Supabase 数据库）

## 已完成

- [x] DESIGN.md 设计文档完成
- [x] PROGRESS.md 进度记录初始化
- [x] VibeCraft 品牌 Logo 导入到 public/
- [x] data.js 学生数据配置完成
- [x] index.html 页面结构完成
...
- [x] v2.2 留言区支持折叠展开（默认显示3条）+ 滚动条始终可见
- [x] 修复：mask-image 渐变遮挡底部收起按钮 → 改为淡色底边线提示
- [x] 留言排序改为最新在前（DESC）
